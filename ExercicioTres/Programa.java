public class Programa {
    public static void main(String[] args) {
        ...
        BuscaCarros busca = new BuscaCarros();

        int[] array = {1008, 1012, 1014 ,1021, 1026, 1028 ,1035 ,1040 ,1046 ,1051,
            ...
            int[] target = {1440,1521,1040,1225,1370,1579,1901,1515,1770,1620,1095,1263,1105};



           int a = busca.buscaBinaria(array,1440);
           int b = busca.buscaBinaria(array,1521);
           int c = busca.buscaBinaria(array,1040);
           int d = busca.buscaBinaria(array,1225);
           int e = busca.buscaBinaria(array,1370);
           int f = busca.buscaBinaria(array,1579);
           int g = busca.buscaBinaria(array,1901);
           int h = busca.buscaBinaria(array,1515);
           int i = busca.buscaBinaria(array,1770);
           int j = busca.buscaBinaria(array,1620);
           int k = busca.buscaBinaria(array,1095);
           int l = busca.buscaBinaria(array,1263);
           int m = busca.buscaBinaria(array,1105);

           int[] indices = {a, b, c , d , e , f , g , h , i ,j , k , l , m ,};

            busca.imprimir(target, indices);
    }
}